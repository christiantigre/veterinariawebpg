...
<div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::textarea('description', null, ['class' => 'form-control my-editor','placeholder'=>'Max 500 caracteres']) !!}
...
<div class="form-group {{ $errors->has('mision') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::textarea('mision', null, ['class' => 'form-control my-editor','placeholder'=>'Max 500 caracteres']) !!}
...
<div class="form-group {{ $errors->has('vision') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        {!! Form::textarea('vision', null, ['class' => 'form-control my-editor','placeholder'=>'Max 500 caracteres']) !!}
