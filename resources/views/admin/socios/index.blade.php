                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($socios as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/socios/' . $item->id) }}" title="View Socio"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/socios/' . $item->id . '/edit') }}" title="Edit Socio"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
