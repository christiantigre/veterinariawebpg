                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($gallery as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/gallery/' . $item->id) }}" title="View Gallery"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/gallery/' . $item->id . '/edit') }}" title="Edit Gallery"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
