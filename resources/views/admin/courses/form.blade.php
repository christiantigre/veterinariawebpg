...
</div><div class="form-group {{ $errors->has('tipecourse_id') ? 'has-error' : ''}}">
    {!! Form::label('tipecourse_id', 'Tipecourse Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::select('tipecourse_id', $tipes, null, ['class' => 'form-control']) !!}
        {!! $errors->first('tipecourse_id', '<p class="help-block">:message</p>') !!}
    </div>
</div>
