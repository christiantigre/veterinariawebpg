...
</div><div class="form-group {{ $errors->has('compfb') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('comptw') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('compgg') ? 'has-error' : ''}}">
